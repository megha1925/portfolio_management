...
public class MutualFundController {
	...
	public MutualFund getMutualFundDetails(@RequestHeader("Authorization") String authorization,
			@PathVariable String mutualFundName) throws MutualFundNotFoundException, UserNotAuthorizedException {
	...
	public List<MutualFund> getAllMutualFund(@RequestHeader("Authorization") String authorization) throws MutualFundNotFoundException, UserNotAuthorizedException {
		if(!authorizationClient.authorizeRequest(authorization)){
			throw new UserNotAuthorizedException("UNAUTHORIZED");
		}
