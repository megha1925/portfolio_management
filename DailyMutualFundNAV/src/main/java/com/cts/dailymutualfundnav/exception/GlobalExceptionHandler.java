...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleGlobalException(UserNotAuthorizedException ex, WebRequest request) {
        Map<String, String> errorMap = new HashMap<>();
        errorMap.put(MESSAGE, ex.getMessage());
        ExceptionDetails exceptionDetails = new ExceptionDetails(LocalDateTime.now(), errorMap);
        log.error(ex.getMessage());
    ...
    /**
     * Handle Mutual Funds Not Found exception response entity.
     *
     * @param ex the ex
     * @return the response entity
     */
    @ExceptionHandler(MutualFundNotFoundException.class)
    public ResponseEntity<ExceptionDetails> handleUnevenDatesException(MutualFundNotFoundException ex) {
        Map<String, String> errorMap = new HashMap<>();
        errorMap.put(MESSAGE,ex.getMessage());
        ExceptionDetails exceptionDetails = new ExceptionDetails(LocalDateTime.now() , errorMap);
        log.error(ex.getMessage());
